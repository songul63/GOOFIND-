...
assert.match(enNews[0].content, /conducted public consultations|date-modified 17 September 2026|dcterms\.modified stamp is still 16 September 2026|footer dateModified remains 31 July 2026/);
assert.match(trNews[0].content, /conducted public consultations|17 Eylül 2026 tarihli date-modified|dcterms\.modified damgası hâlâ 16 Eylül 2026|dateModified alanı 31 Temmuz 2026/);
...
assert.match(enNews[1].content, /Last-Modified header remains 16 September 2026 at 13:53:31 GMT|#443|#442|#441|#440/);
assert.match(trNews[1].content, /Last-Modified başlığı 16 Eylül 2026 13\.53\.31 GMT|#443|#442|#441|#440/);
assert.match(enNews[0].content, /22:00 UTC on 17 September 2026/);
assert.match(trNews[0].content, /17 Eylül 2026 22\.00 UTC/);
