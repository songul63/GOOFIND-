...
assert.match(enNews[0].content, /13:20 UTC on 18 September 2026/);
assert.match(trNews[0].content, /18 Eylül 2026 13\.20 UTC/);
assert.match(enNews[1].content, /13:53:31 GMT/);
assert.match(trNews[1].content, /13\.53\.31 GMT/);
assert.match(enNews[1].content, /07:33:34 GMT/);
assert.match(trNews[1].content, /07\.33\.34 GMT/);
assert.match(enNews[1].content, /07:34:56 GMT/);
assert.match(trNews[1].content, /07\.34\.56 GMT/);
