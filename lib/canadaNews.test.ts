...
assert.match(enNews[0].content, /in negotiations|NATO Summit|4\.3 billion|lentils|4,650|TCE-Consultations/);
assert.match(trNews[0].content, /müzakerede|NATO Zirvesi|4,3 milyar|mercimek|4\.650|TCE-Consultations/);
...
assert.match(enNews[1].content, /12 months|NOC 41220|41221|42202|in Canada or abroad|does not need to be continuous/);
assert.match(trNews[1].content, /12 aylık|NOC 41220|41221|42202|Kanada’da veya yurt dışında|kesintisiz olması/);
