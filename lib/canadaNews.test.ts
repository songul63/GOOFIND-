...
assert.match(enNews[0].content, /in negotiations|NATO Summit|flat-rolled iron|TCE-Consultations/);
assert.match(trNews[0].content, /müzakerede|NATO Zirvesi|yassı haddelenmiş|TCE-Consultations/);
assert.match(enNews[1].title, /Express Entry|Healthcare|social services/i);
assert.match(trNews[1].title, /Express Entry|Sağlık|sosyal hizmet/);
assert.match(enNews[1].content, /12 months|NOC 31102|31301|41300|does not need to be continuous/);
assert.match(trNews[1].content, /12 aylık|NOC 31102|31301|41300|kesintisiz olması/);
