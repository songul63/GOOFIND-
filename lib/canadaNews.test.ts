...
assert.match(enNews[1].content, /12 months|NOC 31100|31101|31102|in Canada|does not need to be continuous|5,000/);
assert.match(trNews[1].content, /12 aylık|NOC 31100|31101|31102|Kanada’da|kesintisiz olması|5\.000/);
