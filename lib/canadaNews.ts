...
export function getDefaultCanadaNews(lang: 'en' | 'tr'): CanadaNewsItem[] {
    ...
    return [
      {
        ...
        desc: 'July 7 launch after June Bolat–Sidhu talks; 2024 top exports lentils, scrap steel and soybeans.',
        content:
      ...
      },
      {
        ...
        desc: 'This Sunday, 12 p.m.–8 p.m. at 1 Dundas Street East; free, with a Turkish book fair.',
        content:
  ...
  return [
    ...
    },
    {
      ...
      desc: 'Bu Pazar 12.00–20.00, 1 Dundas Street East; ücretsiz, Türk kitap fuarı da var.',
      content:
