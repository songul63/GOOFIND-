...
assert.match(enNews[0].content, /19:32 UTC on 18 September 2026/);
assert.match(trNews[0].content, /18 Eylül 2026 19\.32 UTC/);
assert.match(enNews[1].content, /13:53:31 GMT/);
assert.match(trNews[1].content, /13\.53\.31 GMT/);
assert.match(enNews[1].content, /19:26:54 GMT/);
assert.match(trNews[1].content, /19\.26\.54 GMT/);
assert.match(enNews[1].content, /19:29:38 GMT/);
assert.match(trNews[1].content, /19\.29\.38 GMT/);
assert.match(enNews[1].content, /18:33:37 GMT/);
assert.match(trNews[1].content, /18\.33\.37 GMT/);
