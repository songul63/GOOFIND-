...
assert.match(enNews[0].content, /in negotiations|NATO Summit|4\.3 billion|tugboats|JETCO|TCE-Consultations/);
assert.match(trNews[0].content, /müzakerede|NATO Zirvesi|4,3 milyar|römorkör|JETCO|TCE-Consultations/);
...
assert.match(trNews[1].title, /Express Entry|ulaşım/i);
assert.match(enNews[1].content, /12 months|NOC 72404|72600|22313|72410|in Canada or abroad|does not need to be continuous/);
assert.match(trNews[1].content, /12 aylık|NOC 72404|72600|22313|72410|Kanada’da veya yurt dışında|kesintisiz olması/);
assert.match(enNews[2].title, /Anatolia Fest/);
assert.match(trNews[2].title, /Anatolia Fest/);
assert.match(enNews[2].content, /Sankofa Square|kutuphane\.ca|book fair|Turkish Airlines/i);
assert.match(trNews[2].content, /Sankofa Square|kutuphane\.ca|kitap fuarı|Turkish Airlines/i);
