...
assert.match(enNews[0].content, /in negotiations|4\.3 billion|lentils|TCE-Consultations/);
assert.match(trNews[0].content, /müzakerede|4,3 milyar|mercimek|TCE-Consultations/);
assert.match(enNews[1].title, /Express Entry|French/i);
assert.match(trNews[1].title, /Express Entry|Fransızca/);
assert.match(enNews[1].content, /NCLC 7|25 additional|50 points|9% \(30,267/);
assert.match(trNews[1].content, /NCLC 7|25 ek puan|50 ek puan|%9 \(30\.267/);
