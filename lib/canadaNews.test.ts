...
assert.match(enNews[1].title, /Express Entry|military|recruits/i);
assert.match(trNews[1].title, /Express Entry|askeri/i);
assert.match(enNews[1].content, /FSMA|40042|42102|43204|ten years|three years/);
assert.match(trNews[1].content, /FSMA|40042|42102|43204|on yıl|üç yıl/);
assert.doesNotMatch(enNews[1].content, /\bITA\b|CRS/);
assert.doesNotMatch(trNews[1].content, /\bITA\b|CRS/);
