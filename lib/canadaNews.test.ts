...
assert.match(enNews[0].content, /in negotiations|4\.3 billion|lentils and chickpeas|420 million|TCE-Consultations/);
assert.match(trNews[0].content, /müzakerede|4,3 milyar|mercimek ve nohut|420 milyon|TCE-Consultations/);
...
assert.match(enNews[1].content, /NCLC|CLB 5|50,701|9%|30,267|12%/);
assert.match(trNews[1].content, /NCLC|CLB 5|50\.701|%9|30\.267|%12/);
