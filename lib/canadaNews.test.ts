...
assert.match(enNews[0].content, /lentils and chickpeas|65,000|KFOR|soybeans|exploratory/);
assert.match(trNews[0].content, /mercimek ve nohut|65\.000|KFOR|soya|keşif/);
assert.match(enNews[1].title, /Express Entry|STEM/i);
assert.match(trNews[1].title, /Express Entry|STEM/i);
assert.match(enNews[1].content, /12 months|20011|21220|5,942|5\.8%/);
assert.match(trNews[1].content, /12 aylık|20011|21220|5\.942|%5,8/);
