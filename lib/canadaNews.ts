    ...
    return [
      {
        ...
        desc: 'July 7 NATO launch; 2024 top exports lentils, steel scrap and soybeans; diaspora 65,000+.',
        content:
          'Global Affairs Canada lists the Canada–Türkiye free trade agreement’s current status as in negotiations. On July 7, 2026, on the margins of the NATO Summit in Ankara, Prime Minister Mark Carney and President Recep Tayyip Erdoğan announced the launch of talks toward a comprehensive, modern, and mutually beneficial FTA. Their joint statement said closer economic cooperation will support growth, job creation, competitiveness and supply chains, and that in the coming months technical teams will define the scope and ambition of the agreement and prepare for the first round of negotiations. Public consultations ran from July 31 to September 14, 2026. Canada and Türkiye have longstanding diplomatic relations: Türkiye opened an Embassy in Ottawa in 1944, and Canada appointed its first Ambassador to Türkiye in 1947. GAC’s relations page welcomes a vibrant Turkish diaspora community of over 65,000, concentrated in Toronto, Montreal, Vancouver, Ottawa, Hamilton, Calgary and Edmonton. The same page reports that in 2024 two-way merchandise trade was over $4.3 billion — Canadian merchandise exports totalling $1.3 billion and imports from Türkiye $3.1 billion — and Canada’s top 2024 exports to Türkiye were lentils and chickpeas ($393 million), iron and steel waste and scrap ($167 million), and soybeans ($113 million). Türkiye and Canada’s Armed Forces have a longstanding NATO cooperation, including the Kosovo Force (KFOR) and the NATO Mission in Iraq. Questions can be sent to Trade Negotiations Division (TCE), 111 Sussex Drive, Ottawa, ON K1N 1J1, or TCE-Consultations@international.gc.ca.',
        category: 'Economy',
        color: 'bg-primary',
      ...
      },
      {
        ...
        desc: 'This Sunday, 12 p.m.–8 p.m.; free Turkish culture, art and taste festival at 1 Dundas Street East.',
        content:
  ...
  return [
    {
      ...
      desc: '7 Temmuz NATO lansmanı; 2024 başlıca ihracat mercimek, çelik hurdası ve soya; 65.000+ diaspora.',
      content:
        'Küresel İşler Kanada, Kanada–Türkiye serbest ticaret anlaşmasının güncel durumunu müzakerede olarak listeliyor. 7 Temmuz 2026’da, Ankara’daki NATO Zirvesi marjında Başbakan Mark Carney ve Cumhurbaşkanı Recep Tayyip Erdoğan kapsamlı, modern ve karşılıklı yarar sağlayan bir STA müzakeresinin başlatıldığını duyurdu. Ortak açıklamada daha yakın ekonomik iş birliğinin büyümeyi, istihdamı, rekabet gücünü ve tedarik zincirlerini destekleyeceği belirtildi; önümüzdeki aylarda teknik ekipler anlaşmanın kapsamı ve hedefini belirleyecek ve ilk müzakere turuna hazırlanacak. Kamu istişareleri 31 Temmuz–14 Eylül 2026 tarihleri arasında yapıldı. Kanada ve Türkiye’nin köklü diplomatik ilişkileri vardır: Türkiye 1944’te Ottawa’da Büyükelçilik açtı, Kanada 1947’de Türkiye’ye ilk Büyükelçisini atadı. GAC ilişkiler sayfası Toronto, Montreal, Vancouver, Ottawa, Hamilton, Calgary ve Edmonton’da yoğunlaşan 65.000’den fazla kişilik canlı bir Türk diasporasını karşılıyor. Aynı sayfaya göre 2024’te iki yönlü mal ticareti 4,3 milyar doları aştı — Kanada mal ihracatı 1,3 milyar, Türkiye’den ithalat 3,1 milyar dolar — ve 2024’te Türkiye’ye başlıca ihracat mercimek ve nohut (393 milyon dolar), demir-çelik atık ve hurdası (167 milyon) ile soya fasulyesi (113 milyon) oldu. Türkiye ve Kanada Silahlı Kuvvetleri, Kosova Gücü (KFOR) ve Irak’taki NATO Misyonu dahil uzun süredir NATO çerçevesinde iş birliği yapıyor. Sorular Ticaret Müzakereleri Birimi’ne (TCE), 111 Sussex Drive, Ottawa, ON K1N 1J1 veya TCE-Consultations@international.gc.ca adresine gönderilebilir.',
      category: 'Ekonomi',
      color: 'bg-primary',
      link: 'https://www.international.gc.ca/trade-commerce/trade-agreements-accords-commerciaux/agr-acc/turkiye/fta-ale/info.aspx?lang=eng',
    },
    ...
    },
    {
      ...
      desc: 'Bu Pazar 12.00–20.00; 1 Dundas Street East’te ücretsiz Türk kültürü, sanat ve tat festivali.',
      content:
        'Anatolia Fest bu Pazar, 20 Eylül 2026, 12.00–20.00 saatleri arasında Toronto merkezindeki Sankofa Square’de, 1 Dundas Street East adresinde geri dönüyor. Sankofa Square, Anatolia Fest: Türk Kültürü, Sanat ve Tat Festivali’ni ücretsiz, aile dostu bir buluşma olarak listeliyor; Türk mutfağı, geleneksel sanatlar, canlı müzik ve kültürel gösteriler, uygulamalı etkinlikler ve Türk kitap fuarı yer alıyor; sponsorlar Turkish Airlines ve GoTürkiye. 2016 ve 2017 festivallerinin ardından anatoliafest.ca uzun zamandır beklenen 3. edisyonu bir yeniden birleşme olarak anlatıyor — Türk kahvesi ve baklava, müzik, el sanatları ve yöresel sanat. Ev sahibi kutuphane.ca (Anatolia Fest Vol. 3) herkesi kentin kalbinde Türkiye’den geleneksel müzik, dans, mutfak ve sanata davet ediyor. Güncellemeler için @anatoliafestca hesabını takip edin veya info@anatoliafest.ca adresine yazın.',
      category: 'Topluluk',
      color: 'bg-primary',
      link: 'https://www.anatoliafest.ca/',
    },
