    ...
    return [
      {
        ...
        desc: 'June Bolat–Sidhu exploratory talks led to the July 7 launch; JETCO Ottawa met in January.',
        content:
          'Global Affairs Canada lists the Canada–Türkiye free trade agreement’s current status as in negotiations. In early June 2026, Trade Ministers Bolat and Sidhu issued a Joint Ministerial Statement on Economic Partnership launching exploratory discussions toward a comprehensive FTA. On July 7, 2026, on the margins of the NATO Summit in Ankara, Prime Minister Mark Carney and President Recep Tayyip Erdoğan announced the launch of talks toward a comprehensive, modern, and mutually beneficial FTA. Their joint statement said closer economic cooperation will support growth, job creation, competitiveness and supply chains, and that in the coming months technical teams will define the scope and ambition of the agreement and prepare for the first round of negotiations. Public consultations ran from July 31 to September 14, 2026. On January 20, 2026, Canada hosted the second Joint Economic and Trade Committee (JETCO) meeting in Ottawa, co-chaired by Rob Stewart and Mustafa Tuzcu, after the inaugural 2019 meeting in Istanbul; the cochairs committed to keep exploring ways to improve air transportation links and highlighted priority sectors including infrastructure, the green economy, energy and mining, aerospace and defence, and renewable energy. GAC’s relations page reports that in 2024 Canada’s top imports from Türkiye were flat-rolled iron sheet products ($203 million), tugboats ($128 million) and pharmaceutical products ($107 million), and that on December 31, 2024 there were 4,650 Turkish citizens holding valid study permits in Canada — a return to 2022 levels and a 23% decrease versus 2023. Questions can be sent to Trade Negotiations Division (TCE), 111 Sussex Drive, Ottawa, ON K1N 1J1, or TCE-Consultations@international.gc.ca.',
        category: 'Economy',
        color: 'bg-primary',
      ...
      },
      {
        ...
        content:
          'Anatolia Fest returns this Sunday, September 20, 2026, from 12 p.m. to 8 p.m. at Sankofa Square, 1 Dundas Street East in downtown Toronto. After festivals in 2016 and 2017, the 3rd edition is billed as a reunion celebrating Turkish culture, heritage and community — Toronto’s celebration of Turkish heritage through culture, art and taste. Sankofa Square’s calendar highlights Turkish coffee and baklava, traditional crafts and art, and music and cultural performances that bring stories to life. Host kutuphane.ca (Anatolia Fest Vol. 3) invites everyone to traditional music, dance, cuisine and arts from Türkiye in the heart of the city. Follow @anatoliafestca or email info@anatoliafest.ca for updates.',
        category: 'Community',
        color: 'bg-primary',
  ...
  return [
    {
      ...
      desc: 'Haziran’daki Bolat–Sidhu keşif görüşmeleri 7 Temmuz’daki lansmana uzandı; JETCO Ottawa Ocak’ta toplandı.',
      content:
        'Küresel İşler Kanada, Kanada–Türkiye serbest ticaret anlaşmasının güncel durumunu müzakerede olarak listeliyor. 2026 Haziran’ının başında Ticaret Bakanları Bolat ve Sidhu, kapsamlı bir STA’ya yönelik keşif görüşmelerini başlatan Ekonomik Ortaklık Ortak Bakanlar Bildirisini yayımladı. 7 Temmuz 2026’da, Ankara’daki NATO Zirvesi marjında Başbakan Mark Carney ve Cumhurbaşkanı Recep Tayyip Erdoğan kapsamlı, modern ve karşılıklı yarar sağlayan bir STA müzakeresinin başlatıldığını duyurdu. Ortak açıklamada daha yakın ekonomik iş birliğinin büyümeyi, istihdamı, rekabet gücünü ve tedarik zincirlerini destekleyeceği belirtildi; önümüzdeki aylarda teknik ekipler anlaşmanın kapsamı ve hedefini belirleyecek ve ilk müzakere turuna hazırlanacak. Kamu istişareleri 31 Temmuz–14 Eylül 2026 tarihleri arasında yapıldı. 20 Ocak 2026’da Kanada, 2019 İstanbul’daki ilk toplantının ardından Ottawa’da ikinci Ortak Ekonomi ve Ticaret Komitesi (JETCO) toplantısına ev sahipliği yaptı; eş başkanlar Rob Stewart ve Mustafa Tuzcu hava ulaşımı bağlantılarını iyileştirme yollarını araştırmaya devam etme sözü verdi ve altyapı, yeşil ekonomi, enerji ve madencilik, havacılık-savunma ve yenilenebilir enerji gibi öncelikli sektörleri öne çıkardı. GAC ilişkiler sayfasına göre 2024’te Türkiye’den başlıca ithalat yassı haddelenmiş demir sac ürünleri (203 milyon dolar), römorkörler (128 milyon) ve eczacılık ürünleri (107 milyon) oldu; 31 Aralık 2024’te Kanada’da geçerli öğrenim izni bulunan 4.650 Türk vatandaşı vardı — 2022 düzeyine dönüş ve 2023’e göre %23 azalma. Sorular Ticaret Müzakereleri Birimi’ne (TCE), 111 Sussex Drive, Ottawa, ON K1N 1J1 veya TCE-Consultations@international.gc.ca adresine gönderilebilir.',
      category: 'Ekonomi',
      color: 'bg-primary',
      link: 'https://www.international.gc.ca/trade-commerce/trade-agreements-accords-commerciaux/agr-acc/turkiye/fta-ale/info.aspx?lang=eng',
    },
    ...
    },
    {
      ...
      content:
        'Anatolia Fest bu Pazar, 20 Eylül 2026, 12.00–20.00 saatleri arasında Toronto merkezindeki Sankofa Square’de, 1 Dundas Street East adresinde geri dönüyor. 2016 ve 2017 festivallerinin ardından 3. edisyon, Türk kültürü, mirası ve toplumunun kutlandığı bir yeniden birleşme — kültür, sanat ve tat yoluyla Toronto’da Türk mirasının kutlanması — olarak anlatılıyor. Sankofa Square takvimi Türk kahvesi ve baklava, geleneksel el sanatları ve sanat ile hikâyeleri hayata geçiren müzik ve kültürel gösterileri öne çıkarıyor. Ev sahibi kutuphane.ca (Anatolia Fest Vol. 3) herkesi kentin kalbinde Türkiye’den geleneksel müzik, dans, mutfak ve sanata davet ediyor. Güncellemeler için @anatoliafestca hesabını takip edin veya info@anatoliafest.ca adresine yazın.',
      category: 'Topluluk',
      color: 'bg-primary',
      link: 'https://www.anatoliafest.ca/',
    },
