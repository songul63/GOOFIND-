...
assert.match(enNews[0].content, /07:05 UTC on 18 September 2026/);
assert.match(trNews[0].content, /18 Eylül 2026 07\.05 UTC/);
assert.match(enNews[1].content, /13:53:31 GMT/);
assert.match(trNews[1].content, /13\.53\.31 GMT/);
assert.match(enNews[1].content, /06:53:02 GMT/);
assert.match(trNews[1].content, /06\.53\.02 GMT/);
