...
assert.match(enNews[0].content, /00:02 UTC on 18 September 2026/);
assert.match(trNews[0].content, /18 Eylül 2026 00\.02 UTC/);
assert.match(enNews[1].content, /20:09:41 GMT/);
assert.match(trNews[1].content, /20\.09\.41 GMT/);
