...
assert.match(enNews[0].content, /in negotiations|NATO Summit|4\.3 billion|lentils and chickpeas|420 million|TCE-Consultations/);
assert.match(trNews[0].content, /müzakerede|NATO Zirvesi|4,3 milyar|mercimek ve nohut|420 milyon|TCE-Consultations/);
...
assert.match(enNews[1].content, /12 months|NOC 20011|21220|21300|in Canada or abroad|does not need to be continuous/);
assert.match(trNews[1].content, /12 aylık|NOC 20011|21220|21300|Kanada’da veya yurt dışında|kesintisiz olması/);
