...
assert.match(enNews[1].title, /Express Entry|healthcare|social services/i);
assert.match(trNews[1].title, /Express Entry|Sağlık|sosyal hizmet/i);
assert.match(enNews[1].content, /12 months|NOC 31102|31301|31302|32101|in Canada or abroad|does not need to be continuous/);
assert.match(trNews[1].content, /12 aylık|NOC 31102|31301|31302|32101|Kanada’da veya yurt dışında|kesintisiz olması/);
