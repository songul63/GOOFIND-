...
assert.match(enNews[0].content, /16:20 UTC on 18 September 2026/);
assert.match(trNews[0].content, /18 Eylül 2026 16\.20 UTC/);
...
assert.match(enNews[1].content, /15:58:59 GMT/);
assert.match(trNews[1].content, /15\.58\.59 GMT/);
