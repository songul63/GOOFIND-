...
assert.match(enNews[0].content, /21:15 UTC on 18 September 2026/);
assert.match(trNews[0].content, /18 Eylül 2026 21\.15 UTC/);
assert.match(enNews[1].content, /13:53:31 GMT/);
assert.match(trNews[1].content, /13\.53\.31 GMT/);
assert.match(enNews[1].content, /21:11:05 GMT/);
assert.match(trNews[1].content, /21\.11\.05 GMT/);
