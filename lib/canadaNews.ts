...
export function getDefaultCanadaNews(lang: 'en' | 'tr'): CanadaNewsItem[] {
    ...
    return [
      {
        ...
        desc: 'July 7 launch; 2024 two-way trade over $4.3B; Canadian FDI in Türkiye fell to $420 million.',
        content:
          'Global Affairs Canada lists the Canada–Türkiye free trade agreement’s current status as in negotiations. On July 7, 2026, on the margins of the NATO Summit in Ankara, Prime Minister Mark Carney and President Recep Tayyip Erdoğan announced the launch of talks toward a comprehensive, modern, and mutually beneficial FTA. Their joint statement said closer economic cooperation will support growth, job creation, competitiveness and supply chains. In the coming months, technical teams will define the scope and ambition of the agreement and prepare for the first round of negotiations. Public consultations ran from July 31 to September 14, 2026. GAC’s relations page reports that in 2024 two-way merchandise trade was over $4.3 billion, with Canadian merchandise exports totalling $1.3 billion and imports from Türkiye $3.1 billion. Canada’s top 2024 imports from Türkiye were flat-rolled iron sheet products ($203 million), tugboats ($128 million) and pharmaceutical products ($107 million). The stock of Canadian direct investment in Türkiye, mostly in the mining sector, fell from $1 billion in 2022 to $420 million in 2023. On December 31, 2024, there were 4,650 Turkish citizens holding valid study permits in Canada — a return to 2022 levels and a 23% decrease from 2023. Questions can be sent to Trade Negotiations Division (TCE), 111 Sussex Drive, Ottawa, ON K1N 1J1, or TCE-Consultations@international.gc.ca.',
        category: 'Economy',
        color: 'bg-primary',
  ...
  return [
    ...
    },
    {
      ...
      desc: 'Hemşire pratisyen, diş hekimi, eczacı, psikolog ve kayropraktörler için tek NOC’ta 12 ay, Kanada’da veya yurt dışında.',
      content:
        'IRCC’nin güncel Express Entry kategori bazlı turları sağlık ve sosyal hizmet mesleklerini kapsıyor. Göçmenlik Bakanı Lena Metlege Diab 18 Şubat 2026’da IRCC’nin bu kategoride davet turlarına devam edeceğini duyurdu; örnekler arasında hemşire pratisyenler, diş hekimleri, eczacılar, psikologlar ve kayropraktörler yer alıyor. Kategori bazlı davet için Express Entry asgari ölçütlerini, kapsadığı üç göçmenlik programından birine uygunluğu ve o turun talimatlarındaki tüm şartları karşılamanız gerekir. Bu kategoride, son üç yıl içinde IRCC listesindeki tek bir meslekte, Kanada’da veya yurt dışında, en az 12 aylık tam zamanlı (veya eşdeğer yarı zamanlı) iş deneyimi biriktirmiş olmalısınız; deneyimin kesintisiz olması veya asıl mesleğiniz olması gerekmez. 2026 listesinde aile hekimleri (NOC 31102, TEER 1), kayıtlı hemşireler ve psikiyatri hemşireleri (31301, TEER 1), hemşire pratisyenler (31302, TEER 1), lisanslı pratisyen hemşireler (32101, TEER 2), eczacılar (31120, TEER 1), diş hekimleri (31110, TEER 1), psikologlar (31200, TEER 1), kayropraktörler (31201, TEER 1), uğraşı terapistleri (31203, TEER 1), paramedikal meslekler (32102, TEER 2), sosyal çalışmacılar (41300, TEER 1), sosyal ve toplum hizmeti çalışanları (42201, TEER 2) ile bakıcılar, hasta bakıcılar ve hasta hizmetleri görevlileri (33102, TEER 3) yer alıyor. Ayrıntılar her turun talimatlarında yer alır; turlar gerçekleştikten sonra yayımlanır.',
      category: 'Göçmenlik',
      color: 'bg-primary',
      link: 'https://www.canada.ca/en/immigration-refugees-citizenship/services/immigrate-canada/express-entry/rounds-invitations/category-based-selection.html',
    },
