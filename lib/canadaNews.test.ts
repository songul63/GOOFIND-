...
assert.match(enNews[0].content, /09:03 UTC on 19 September 2026/);
assert.match(trNews[0].content, /19 Eylül 2026 09\.03 UTC/);
...
assert.match(enNews[1].content, /07:57:52 GMT/);
assert.match(trNews[1].content, /07\.57\.52 GMT/);
assert.match(enNews[1].content, /08:06:52 GMT/);
assert.match(trNews[1].content, /08\.06\.52 GMT/);
...
assert.match(enNews[1].content, /Last hour they also both succeeded over HTTP\/2 and HTTP\/1\.1/);
assert.match(trNews[1].content, /HTTP\/2 ve HTTP\/1\.1 üzerinden başarılı oldu/);
assert.match(trNews[1].content, /Geçen saat de her ikisi HTTP\/2 ve HTTP\/1\.1 üzerinden başarılı oldu/);
...
assert.doesNotMatch(enNews[1].content, /HTTP\/2 stream INTERNAL_ERROR/);
assert.doesNotMatch(trNews[1].content, /HTTP\/2 stream INTERNAL_ERROR/);
