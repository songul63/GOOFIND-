...
assert.match(enNews[1].content, /12 months|NOC 41220|41221|42202|does not need to be continuous/);
assert.match(trNews[1].content, /12 aylık|NOC 41220|41221|42202|kesintisiz olması/);
