...
assert.match(enNews[1].content, /12 months|NOC 20011|21220|21300|does not need to be continuous/);
assert.match(trNews[1].content, /12 aylık|NOC 20011|21220|21300|kesintisiz olması/);
