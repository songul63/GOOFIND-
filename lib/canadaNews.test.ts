...
assert.match(enNews[0].content, /in negotiations|NATO Summit|4\.3 billion|TCE-Consultations|KFOR|Air Transport Agreement/);
assert.match(trNews[0].content, /müzakerede|NATO Zirvesi|4,3 milyar|TCE-Consultations|KFOR|Hava Ulaşım Anlaşması/);
...
assert.match(enNews[1].content, /FSMA|ten years|NOC 40042|42102|43204|Canadian Forces Recruiting Group|Defence Industrial Strategy/);
assert.match(trNews[1].content, /FSMA|on yıl|NOC 40042|42102|43204|Kanada Kuvvetleri İşe Alım Grubu|Savunma Sanayii Stratejisi/);
