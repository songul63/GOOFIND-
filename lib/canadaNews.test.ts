...
assert.match(enNews[0].content, /lentils and chickpeas|65,000|KFOR|soybeans/);
assert.match(trNews[0].content, /mercimek ve nohut|65\.000|KFOR|soya/);
assert.match(enNews[1].title, /Express Entry|French/i);
assert.match(trNews[1].title, /Express Entry|Fransızca/i);
assert.match(enNews[1].content, /NCLC 7|50,701|49\.2%|CLB 5|30,267|Francophone/);
assert.match(trNews[1].content, /NCLC 7|50\.701|%49,2|CLB 5|30\.267|Frankofon/);
