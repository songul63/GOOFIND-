...
assert.match(enNews[0].content, /TCE-Consultations@international\.gc\.ca|111 Sussex/);
assert.match(enNews[1].title, /Express Entry|senior manager/i);
assert.match(trNews[1].title, /Express Entry|üst düzey/);
assert.match(enNews[1].content, /00012|00013|00014|00015/);
assert.match(trNews[1].content, /00012|00013|00014|00015/);
assert.match(enNews[2].title, /Anatolia Fest/);
assert.match(trNews[2].title, /Anatolia Fest/);
assert.match(enNews[2].content, /free|family-friendly/i);
