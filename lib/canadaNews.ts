  ...
  if (lang === 'en') {
    return [
      ...
      },
      {
        ...
        desc: 'Cybersecurity and engineering remain current IRCC categories.',
        content:
          'IRCC’s current Express Entry category-based rounds still include Science, Technology, Engineering and Math (STEM) occupations. Eligible candidates generally need at least 12 months of full-time experience (or equal part-time) in the past three years in a listed occupation such as cybersecurity specialists, civil, mechanical, or electrical and electronics engineers, plus eligibility for an Express Entry program. Architecture and science managers, industrial and geological engineers, and several engineering technologist roles are also listed. Turkish-community applicants in these fields should keep NOC codes and Express Entry profiles current — IRCC publishes each round after it runs.',
  ...
  return [
    {
      ...
      content:
        'Bugün, 14 Eylül 2026, olası bir Kanada–Türkiye serbest ticaret anlaşması için görüş bildirmenin son günü. Küresel İşler Kanada sayfası istişareyi hâlâ Açık gösteriyor (31 Temmuz–14 Eylül). 2025’te iki yönlü mal ticareti 4,3 milyar CA$’ı aştı (ihracat yaklaşık 1,1 milyar, ithalat yaklaşık 3,2 milyar). Kanada’nın Türkiye’deki doğrudan yatırımı 2022’deki 1 milyar CA$’dan 3,3 milyar CA$’a çıktı. Türkiye’nin Kanada’daki doğrudan yatırımı 233 milyon CA$ idi; bu, Avrupa’dan Kanada’ya gelen yatırımlarda 24., dünyada 54. sıraya karşılık geliyor. Başbakan Mark Carney ve Cumhurbaşkanı Recep Tayyip Erdoğan müzakereleri 7 Temmuz’da duyurmuştu. Türk-Kanadalı işletmeler, KOBİ’ler dahil, görüşlerini hâlâ TCE-consultations@international.gc.ca adresine iletebilir; bakanlık bu katkının STA müzakerelerini şekillendireceğini belirtiyor.',
      category: 'Ekonomi',
      color: 'bg-primary',
      link: 'https://international.canada.ca/en/global-affairs/consultations/trade/2026-07-29-turkiye',
    },
    {
      ...
      desc: 'Siber güvenlik ve mühendislik hâlâ güncel IRCC kategorileri.',
      content:
        'IRCC’nin güncel Express Entry kategori bazlı turları Bilim, Teknoloji, Mühendislik ve Matematik (STEM) mesleklerini kapsamaya devam ediyor. Adayların genellikle son üç yılda listelenen tek bir meslekte en az 12 ay tam zamanlı (veya eşdeğer yarı zamanlı) deneyim ve bir Express Entry programına uygunluk göstermesi gerekiyor. Listede siber güvenlik uzmanları, inşaat, makine, elektrik ve elektronik mühendisleri; mimarlık ve bilim yöneticileri, endüstri ve jeoloji mühendisleri ile bazı mühendislik teknologları yer alıyor. Bu alanlardaki Türk toplumundaki adayların NOC kodları ve Express Entry profillerini güncel tutması önerilir; turlar gerçekleştikten sonra yayımlanır.',
      category: 'Göçmenlik',
      color: 'bg-primary',
      link: 'https://www.canada.ca/en/immigration-refugees-citizenship/services/immigrate-canada/express-entry/rounds-invitations/category-based-selection.html',
    },
