...
assert.match(enNews[0].content, /Current status: Closed|consultation page now lists|report summarizing the feedback|what-we-heard report has not yet been published|in negotiations|NATO Summit|4\.3 billion|TCE-Consultations/);
