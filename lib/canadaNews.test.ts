...
assert.match(enNews[0].content, /15:15 UTC on 18 September 2026/);
assert.match(trNews[0].content, /18 Eylül 2026 15\.15 UTC/);
assert.match(enNews[1].content, /13:53:31 GMT/);
assert.match(trNews[1].content, /13\.53\.31 GMT/);
assert.match(enNews[1].content, /14:47:05 GMT/);
assert.match(trNews[1].content, /14\.47\.05 GMT/);
assert.match(enNews[1].content, /14:46:11 GMT/);
assert.match(trNews[1].content, /14\.46\.11 GMT/);
