...
assert.match(enNews[0].content, /22:10 UTC on 18 September 2026/);
assert.match(trNews[0].content, /18 Eylül 2026 22\.10 UTC/);
...
assert.match(enNews[1].content, /failed over HTTP\/2/);
assert.match(enNews[1].content, /timed out over HTTP\/1\.1/);
assert.match(trNews[1].content, /HTTP\/2 üzerinden başarısız/);
assert.match(trNews[1].content, /zaman aşımına uğradı/);
