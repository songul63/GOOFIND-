...
assert.match(enNews[0].content, /18:17 UTC on 18 September 2026/);
assert.match(trNews[0].content, /18 Eylül 2026 18\.17 UTC/);
assert.match(enNews[1].content, /13:53:31 GMT/);
assert.match(trNews[1].content, /13\.53\.31 GMT/);
assert.match(enNews[1].content, /18:14:31 GMT/);
assert.match(trNews[1].content, /18\.14\.31 GMT/);
assert.match(enNews[1].content, /16:18:02 GMT/);
assert.match(trNews[1].content, /16\.18\.02 GMT/);
assert.match(enNews[1].content, /16:22:39 GMT/);
assert.match(trNews[1].content, /16\.22\.39 GMT/);
