...
assert.match(trNews[1].content, /#445 yayımlanmamıştır|daha yeni bir tur|#444.ten sonra/i);
assert.match(enNews[0].content, /08:05 UTC on 18 September 2026/);
assert.match(trNews[0].content, /18 Eylül 2026 08\.05 UTC/);
