...
assert.match(enNews[0].content, /17:15 UTC on 19 September 2026/);
assert.match(trNews[0].content, /19 Eylül 2026 17\.15 UTC/);
...
assert.match(enNews[1].content, /11:12:53 GMT/);
assert.match(trNews[1].content, /11\.12\.53 GMT/);
