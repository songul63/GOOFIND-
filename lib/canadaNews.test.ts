...
assert.match(enNews[0].content, /04:05 UTC on 18 September 2026/);
assert.match(trNews[0].content, /18 Eylül 2026 04\.05 UTC/);
assert.match(enNews[1].content, /19:58:34 GMT/);
assert.match(trNews[1].content, /19\.58\.34 GMT/);
assert.match(enNews[1].content, /timed out over HTTP\/1\.1|HTTP\/1\.1.*timed out/);
assert.match(trNews[1].content, /HTTP\/1\.1.*zaman aşım|zaman aşımına uğradı/);
