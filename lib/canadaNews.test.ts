...
assert.match(enNews[1].content, /12 months|NOC 72404|72600|22313|72410|does not need to be continuous/);
assert.match(trNews[1].content, /12 aylık|NOC 72404|72600|22313|72410|kesintisiz olması/);
assert.match(enNews[2].title, /Anatolia Fest/);
assert.match(trNews[2].title, /Anatolia Fest/);
assert.match(enNews[2].content, /Sankofa Square|kutuphane\.ca|baklava|book fair/i);
assert.match(trNews[2].content, /Sankofa Square|kutuphane\.ca|baklava|kitap fuarı/i);
