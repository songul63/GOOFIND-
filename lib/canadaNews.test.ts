...
assert.match(enNews[0].content, /20:10 UTC on 18 September 2026/);
assert.match(trNews[0].content, /18 Eylül 2026 20\.10 UTC/);
assert.match(enNews[1].content, /13:53:31 GMT/);
assert.match(trNews[1].content, /13\.53\.31 GMT/);
assert.match(enNews[1].content, /20:07:17 GMT/);
assert.match(trNews[1].content, /20\.07\.17 GMT/);
assert.match(enNews[1].content, /19:29:38 GMT/);
assert.match(trNews[1].content, /19\.29\.38 GMT/);
assert.match(enNews[1].content, /19:24:10 GMT/);
assert.match(trNews[1].content, /19\.24\.10 GMT/);
...
assert.doesNotMatch(enNews[1].content, /failed over HTTP\/2/);
assert.doesNotMatch(enNews[1].content, /timed out over HTTP\/1\.1/);
assert.doesNotMatch(trNews[1].content, /HTTP\/2 üzerinden başarısız/);
