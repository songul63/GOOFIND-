  ...
  return [
    {
      ...
      desc: '31 Temmuz–14 Eylül penceresi bitti; GAC hâlâ müzakerede diyor, ekipler ilk tura hazırlanıyor.',
      content:
        'Küresel İşler Kanada, Kanada–Türkiye serbest ticaret anlaşmasının güncel durumunu müzakerede olarak listeliyor. Kamu istişareleri 31 Temmuz–14 Eylül 2026 tarihleri arasında yapıldı ve bu pencere artık kapandı; Ticaret Müzakereleri Birimi’ne (TCE) iletilen görüşler Kanada’nın açılış pozisyonunu şekillendirecek. 7 Temmuz 2026’da, Ankara’daki NATO Zirvesi marjında Başbakan Mark Carney ve Cumhurbaşkanı Recep Tayyip Erdoğan kapsamlı, modern ve karşılıklı yarar sağlayan bir STA müzakeresinin başlatıldığını duyurdu. Ortak açıklamada, 2026’nın erken haziranında Ticaret Bakanları Bolat ve Sidhu’nun Ekonomik Ortaklık Ortak Bakanlar Açıklaması ile keşif görüşmelerini başlattığı; daha yakın ekonomik iş birliğinin büyümeyi, istihdamı, rekabet gücünü ve tedarik zincirlerini destekleyeceği belirtildi. Önümüzdeki aylarda teknik ekipler anlaşmanın kapsamı ve hedefini belirleyecek ve ilk müzakere turuna hazırlanacak. GAC ilişkiler sayfası diplomatik bağları Türkiye’nin 1944 Ottawa büyükelçiliği ve Kanada’nın 1947’deki ilk büyükelçisinden başlatır; 65.000’den fazla kişilik Türk diasporası Toronto, Montreal, Vancouver, Ottawa, Hamilton, Calgary ve Edmonton’da yoğunlaşır. 2024’te iki yönlü mal ticareti 4,3 milyar doları aştı — Kanada mal ihracatı 1,3 milyar, Türkiye’den ithalat 3,1 milyar dolar. Kanada’nın 2024’te Türkiye’ye başlıca ihracatı mercimek ve nohut (393 milyon dolar), demir ve çelik atık ve hurdası (167 milyon) ve soya fasulyesi (113 milyon) oldu. Türkiye ve Kanada silahlı kuvvetlerinin NATO ittifakı çerçevesinde uzun süredir iş birliği vardır; Kosova Gücü (KFOR) ve Irak’taki NATO Misyonu buna örnektir. Fırsatlar özellikle tarım, enerji, BİT, yaşam bilimleri, ulaşım, temiz teknoloji, madencilik, eğitim ve altyapı sektörlerinde. Sorular hâlâ TCE’ye, 111 Sussex Drive, Ottawa, ON K1N 1J1 veya TCE-Consultations@international.gc.ca adresine gönderilebilir.',
      category: 'Ekonomi',
      color: 'bg-primary',
      link: 'https://www.international.gc.ca/trade-commerce/trade-agreements-accords-commerciaux/agr-acc/turkiye/fta-ale/info.aspx?lang=eng',
    },
