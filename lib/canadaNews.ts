    ...
    return [
      {
        ...
        desc: 'Early June exploratory talks then July 7 NATO Summit launch; 2024 top exports lentils, steel scrap and soybeans.',
        content:
  ...
  return [
    {
      id: 'fallback-trade',
        ...
        desc: 'Haziran başı keşif görüşmeleri, ardından 7 Temmuz NATO Zirvesi lansmanı; 2024 başlıca ihracat mercimek, çelik hurdası ve soya.',
        content:
