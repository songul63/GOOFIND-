...
assert.match(enNews[0].content, /flat-rolled iron|420 million|4,650|JETCO/);
assert.match(trNews[0].content, /yassı haddelenmiş demir|420 milyon|4\.650|JETCO/);
...
assert.match(enNews[1].content, /12 months|31301|31302|19,200|18\.6%/);
assert.match(trNews[1].content, /12 aylık|31301|31302|19\.200|%18,6/);
