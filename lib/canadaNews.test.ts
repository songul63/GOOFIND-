...
assert.match(enNews[0].content, /17:10 UTC on 18 September 2026/);
assert.match(trNews[0].content, /18 Eylül 2026 17\.10 UTC/);
assert.match(enNews[1].content, /13:53:31 GMT/);
assert.match(trNews[1].content, /13\.53\.31 GMT/);
assert.match(enNews[1].content, /16:27:54 GMT/);
assert.match(trNews[1].content, /16\.27\.54 GMT/);
