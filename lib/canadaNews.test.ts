...
assert.match(enNews[0].content, /in negotiations|NATO Summit|4\.3 billion|420 million|TCE-Consultations/);
assert.match(trNews[0].content, /müzakerede|NATO Zirvesi|4,3 milyar|420 milyon|TCE-Consultations/);
...
assert.match(enNews[1].content, /12 months|NOC 70010|72200|72300|does not need to be continuous/);
assert.match(trNews[1].content, /12 aylık|NOC 70010|72200|72300|kesintisiz olması/);
