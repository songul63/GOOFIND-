...
assert.match(enNews[0].content, /14:10 UTC on 18 September 2026/);
assert.match(trNews[0].content, /18 Eylül 2026 14\.10 UTC/);
...
assert.match(enNews[1].content, /08:05:36 GMT/);
assert.match(trNews[1].content, /08\.05\.36 GMT/);
