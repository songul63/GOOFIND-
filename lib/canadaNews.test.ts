...
assert.match(enNews[0].content, /NATO Summit|Ankara|TCE|233 million|3\.3 billion/);
assert.match(trNews[0].content, /NATO Zirvesi|Ankara|TCE|233 milyon|3,3 milyar/);
assert.match(enNews[1].title, /Express Entry|military/i);
assert.match(trNews[1].title, /Express Entry|askeri/);
assert.match(enNews[1].content, /40042|42102|43204|Canadian Forces Recruiting Group/);
assert.match(trNews[1].content, /40042|42102|43204|İşe Alım/);
