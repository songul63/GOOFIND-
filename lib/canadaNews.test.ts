...
assert.match(enNews[1].content, /12 months|31100|31101|31102|in Canada|5,000|60 days/);
assert.match(trNews[1].content, /12 aylık|31100|31101|31102|Kanada’da|5\.000|60 gün/);
