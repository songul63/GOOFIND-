...
export function getDefaultCanadaNews(lang: 'en' | 'tr'): CanadaNewsItem[] {
  if (lang === 'en') {
    return [
      ...
      },
      {
        ...
        content:
          'IRCC’s official Express Entry rounds table and official rounds JSON still list round #444 on September 16, 2026, as a category-based invitation for Senior managers with Canadian Work Experience, 2026-Version 1. The published results are 250 invitations issued, with a Comprehensive Ranking System (CRS) score of 389 for the lowest-ranked candidate invited. The ministerial instructions time the round at 12:44:28 UTC on September 16, 2026, and name the Federal Skilled Worker Program, the Canadian Experience Class and the Federal Skilled Trades Program. On February 18, 2026, Immigration Minister Lena Metlege Diab announced this as one of the new 2026 Express Entry categories for senior managers with Canadian work experience. To be eligible for a category-based invitation you must meet the minimum criteria for Express Entry, including being eligible for one of the three immigration programs it covers, and meet all requirements in the instructions for that round. For this category, you must have accumulated, within the past three years, at least 12 months of full-time work experience (or an equal amount of part-time experience) in Canada — the experience does not need to be continuous — in a single occupation listed as Senior managers - financial, communications and other business services (NOC 00012, TEER 0), Senior managers - health, education, social and community services and membership organizations (00013, TEER 0), Senior managers - trade, broadcasting and other services (00014, TEER 0), or Senior managers - construction, transportation, production and utilities (00015, TEER 0). If invited, you must submit your application within 60 days. Full details appear in each round’s instructions; IRCC publishes rounds after they run. This hour official ee_rounds_123_en.json and the official Express Entry rounds HTML page failed again over both HTTP/2 (INTERNAL_ERROR) and HTTP/1.1 (timeout). A retry with a browser user-agent over HTTP/1.1 also timed out after 70 seconds with 0 bytes received, and a second HTTP/2 attempt again returned INTERNAL_ERROR. Last hour they also failed over both HTTP/2 (INTERNAL_ERROR) and HTTP/1.1 (timeout). The last confirmed successful official fetch remains 15:09 UTC on 19 September 2026. The last confirmed official JSON Last-Modified stamp remains Wednesday, 16 September 2026 at 13:53:31 GMT, and the latest listed round is still #444. The last confirmed official Express Entry rounds HTML Last-Modified stamp remains Saturday, 19 September 2026 at 02:00:58 GMT; official files could not be re-fetched this hour, with no September 17, 18 or 19 draw added on the last successful fetch. CIC News homepage Last-Modified this hour remains Saturday, 19 September 2026 at 11:09:13 GMT (same as last hour) and still lists “Canada invites 250 senior managers to apply for permanent residence” as the latest Express Entry story, with no round after #444. The CIC homepage lead this hour is a Prince Edward Island PNP story (195 candidates in priority sectors) — not Express Entry and not used as a banner item. The CIC senior-managers article HTTP Last-Modified this hour is Saturday, 19 September 2026 at 17:58:56 GMT on the canonical 0980361 URL (Saturday, 19 September 2026 at 07:01:40 GMT last hour); article:published_time and article:modified_time remain 2026-09-16T14:43:48+00:00, and its table still starts at September 16 senior managers 389/250 with no September 17, 18 or 19 draw. As of 18:20 UTC on 19 September 2026 no #445 has been published. Last confirmed official round remains #444 from the 16 September 2026 official JSON (Last-Modified Wednesday, 16 September 2026 at 13:53:31 GMT; official files could not be re-fetched this hour). Also previously official on the same JSON: #443 September 15 Canadian Experience Class 2,000 invitations / CRS 519; #442 September 14 Provincial Nominee Program 576 / 734; #441 September 4 Healthcare and Social Services Occupations 3,500 / 475; #440 September 3 Physicians with Canadian Work Experience 229 / 198.',
      ...
      },
      {
        ...
        content:
          'Anatolia Fest: Turkish Culture, Art & Taste Festival returns this Sunday, September 20, 2026, from 12 p.m. to 8 p.m. at Sankofa Square, 1 Dundas Street East in downtown Toronto. Re-checked at 18:16 UTC on 19 September 2026, Sankofa Square still lists the free, family-friendly festival with Turkish cuisine, traditional arts, live music and cultural performances, hands-on activities, and a Turkish book fair, sponsored by Turkish Airlines and GoTürkiye (https://www.sankofasquare.ca/calendar/2026/9/20/anatoliafest). After festivals in 2016 and 2017, anatoliafest.ca frames the long-awaited 3rd edition as a reunion — Turkish coffee and baklava, music, crafts and regional art. Host kutuphane.ca (Anatolia Fest Vol. 3) invites everyone to traditional music, dance, cuisine and arts from Türkiye in the heart of the city. Follow @anatoliafestca or write info@anatoliafest.ca for updates.',
        category: 'Community',
        color: 'bg-primary',
  ...
  return [
    ...
    },
    {
      ...
      content:
        'IRCC’nin resmi Express Entry tur tablosu ve resmi tur JSON’u hâlâ 16 Eylül 2026 tarihli #444 turunu Senior managers with Canadian Work Experience, 2026-Version 1 kategori bazlı daveti olarak listeliyor. Yayımlanan sonuçlar 250 davet ve en düşük davet alan aday için 389 CRS puanıdır. Bakanlık talimatları turu 16 Eylül 2026 12.44.28 UTC olarak zamanlıyor ve Federal Nitelikli İşçi Programı, Kanada Deneyim Sınıfı ile Federal Nitelikli Meslek Programı’nı adlandırıyor. 18 Şubat 2026’da Göçmenlik Bakanı Lena Metlege Diab bunu, Kanada’da çalışma deneyimi olan üst düzey yöneticiler için 2026’nın yeni Express Entry kategorilerinden biri olarak duyurdu. Kategori bazlı davet için Express Entry asgari ölçütlerini, kapsadığı üç göçmenlik programından birine uygunluğu ve o turun talimatlarındaki tüm şartları karşılamanız gerekir. Bu kategoride, son üç yıl içinde Kanada’da en az 12 ay tam zamanlı (veya eşdeğer yarı zamanlı) iş deneyimi biriktirmiş olmalısınız — deneyimin kesintisiz olması gerekmez — ve bu deneyim tek bir meslekte olmalıdır: finans, iletişim ve diğer iş hizmetlerinde üst düzey yöneticiler (NOC 00012, TEER 0), sağlık, eğitim, sosyal ve toplum hizmetleri ile üyelik kuruluşlarında üst düzey yöneticiler (00013, TEER 0), ticaret, yayıncılık ve diğer hizmetlerde üst düzey yöneticiler (00014, TEER 0) veya inşaat, ulaşım, üretim ve kamu hizmetlerinde üst düzey yöneticiler (00015, TEER 0). Davet edilirseniz başvurunuzu 60 gün içinde sunmalısınız. Ayrıntılar her turun talimatlarında yer alır; turlar gerçekleştikten sonra yayımlanır. Bu saatte resmi ee_rounds_123_en.json ve resmi Express Entry tur HTML sayfası yine hem HTTP/2 (INTERNAL_ERROR) hem HTTP/1.1 (zaman aşımı) üzerinden başarısız oldu. Tarayıcı kullanıcı aracısıyla HTTP/1.1 üzerinden yapılan yeniden deneme de 70 saniye sonra 0 baytla zaman aşımına uğradı; ikinci HTTP/2 denemesi yine INTERNAL_ERROR döndü. Geçen saat her ikisi de hem HTTP/2 (INTERNAL_ERROR) hem HTTP/1.1 (zaman aşımı) üzerinden başarısız oldu. Son teyit edilen başarılı resmi indirme 19 Eylül 2026 15.09 UTC olarak kalıyor. Son teyit edilen resmi JSON Last-Modified damgası hâlâ 16 Eylül 2026 Çarşamba 13.53.31 GMT ve listelenen en son tur hâlâ #444. Son teyit edilen resmi Express Entry tur HTML Last-Modified damgası hâlâ 19 Eylül 2026 Cumartesi 02.00.58 GMT; resmi dosyalar bu saat yeniden indirilemedi, son başarılı indirmede 17, 18 veya 19 Eylül turu yoktu. CIC News ana sayfasının Last-Modified damgası bu saatte hâlâ 19 Eylül 2026 Cumartesi 11.09.13 GMT (geçen saatle aynı) ve hâlâ “Canada invites 250 senior managers to apply for permanent residence” başlığını en son Express Entry haberi olarak listeliyor; #444’ten sonra tur yok. CIC ana sayfasının bu saatteki manşeti bir PEI PNP haberi (öncelikli sektörlerde 195 aday) — Express Entry değil ve banner maddesi olarak kullanılmadı. CIC üst düzey yöneticiler yazısının HTTP Last-Modified damgası bu saatte 19 Eylül 2026 Cumartesi 17.58.56 GMT (kanonik 0980361 URL; geçen saat 19 Eylül 2026 Cumartesi 07.01.40 GMT); article:published_time ve article:modified_time hâlâ 2026-09-16T14:43:48+00:00 ve tablosu hâlâ 16 Eylül üst düzey yöneticiler 389/250 ile başlıyor, 17, 18 veya 19 Eylül turu yok. 19 Eylül 2026 18.20 UTC itibarıyla #445 yayımlanmamıştır. Son teyit edilen resmi tur, 16 Eylül 2026 resmi JSON’undaki #444 olarak kalıyor (Last-Modified 16 Eylül 2026 Çarşamba 13.53.31 GMT; resmi dosyalar bu saat yeniden indirilemedi). Aynı JSON’da resmi olarak ayrıca: #443 15 Eylül Kanada Deneyim Sınıfı 2.000 davet / CRS 519; #442 14 Eylül Eyalet Aday Programı 576 / 734; #441 4 Eylül sağlık ve sosyal hizmet meslekleri 3.500 / 475; #440 3 Eylül Kanada deneyimli hekimler 229 / 198.',
      category: 'Göçmenlik',
      color: 'bg-primary',
      link: 'https://www.canada.ca/en/immigration-refugees-citizenship/corporate/mandate/policies-operational-instructions-agreements/ministerial-instructions/express-entry-rounds.html',
    },
