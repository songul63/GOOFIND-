...
assert.match(enNews[0].content, /lentils and chickpeas|65,000|KFOR|soybeans|Bolat and Sidhu|G20/);
assert.match(trNews[0].content, /mercimek ve nohut|65\.000|KFOR|soya|Bolat ve Sidhu|G20/);
assert.match(enNews[1].title, /Express Entry|physicians/i);
assert.match(trNews[1].title, /Express Entry|hekim/i);
assert.match(enNews[1].content, /12 months|31100|31101|31102|in Canada|5,000|60 days|licensed|letters of support/);
assert.match(trNews[1].content, /12 aylık|31100|31101|31102|Kanada’da|5\.000|60 gün|lisans|destek mektubu/);
