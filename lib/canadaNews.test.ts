...
assert.match(enNews[0].content, /lentils and chickpeas|65,000|KFOR|soybeans|Bolat and Sidhu/);
assert.match(trNews[0].content, /mercimek ve nohut|65\.000|KFOR|soya|Bolat ve Sidhu/);
assert.match(enNews[1].title, /Express Entry|education/i);
assert.match(trNews[1].title, /Express Entry|eğitim/i);
assert.match(enNews[1].content, /12 months|41220|41221|42202|9,200|8\.9%/);
assert.match(trNews[1].content, /12 aylık|41220|41221|42202|9\.200|%8,9/);
