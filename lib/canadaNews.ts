    ...
    return [
      {
        ...
        desc: 'June exploratory talks led to the July 7 launch; 2024 top imports iron sheet, tugboats and pharma.',
        content:
          'Global Affairs Canada lists the Canada–Türkiye free trade agreement’s current status as in negotiations. On July 7, 2026, on the margins of the NATO Summit in Ankara, Prime Minister Mark Carney and President Recep Tayyip Erdoğan announced the launch of talks toward a comprehensive, modern, and mutually beneficial FTA. On June 8, 2026, Trade Ministers Maninder Sidhu and Ömer Bolat issued a Joint Ministerial Statement on Economic Partnership launching exploratory discussions; that statement also welcomed the recent expansion of the Air Transport Agreement to strengthen connectivity for travellers, businesses and exporters. On June 26 in Ottawa, Foreign Minister Anita Anand and Türkiye’s Foreign Minister Hakan Fidan explored increased economic engagement in the energy, defence, aerospace and mining sectors. In the coming months, technical teams will define the scope and ambition of the agreement and prepare for the first round of negotiations. Public consultations ran from July 31 to September 14, 2026. Canada hosted the second Canada–Türkiye Joint Economic and Trade Committee (JETCO) meeting in Ottawa on January 20, 2026, following the inaugural 2019 meeting in Istanbul. GAC’s relations page reports that in 2024 two-way merchandise trade was over $4.3 billion, with Canadian exports of $1.3 billion and imports from Türkiye of $3.1 billion. Canada’s top 2024 imports from Türkiye were flat-rolled iron sheet products ($203 million), tugboats ($128 million) and pharmaceutical products ($107 million). The stock of Canadian direct investment in Türkiye, mostly in the mining sector, fell from $1 billion in 2022 to $420 million in 2023. Questions can be sent to Trade Negotiations Division (TCE), 111 Sussex Drive, Ottawa, ON K1N 1J1, or TCE-Consultations@international.gc.ca.',
        category: 'Economy',
        color: 'bg-primary',
  ...
  return [
    {
      ...
      desc: 'Haziran’daki keşif görüşmeleri 7 Temmuz’daki resmi başlangıca yol açtı; 2024 başlıca ithalat demir sac, römorkör ve ilaç.',
      content:
        'Küresel İşler Kanada, Kanada–Türkiye serbest ticaret anlaşmasının güncel durumunu müzakerede olarak listeliyor. 7 Temmuz 2026’da, Ankara’daki NATO Zirvesi marjında Başbakan Mark Carney ve Cumhurbaşkanı Recep Tayyip Erdoğan kapsamlı, modern ve karşılıklı yarar sağlayan bir STA müzakeresinin başlatıldığını duyurdu. 8 Haziran 2026’da Ticaret Bakanları Maninder Sidhu ve Ömer Bolat Ekonomik Ortaklık Ortak Bakanlar Açıklaması yayımlayarak keşif görüşmelerini başlattı; açıklamada yolcular, işletmeler ve ihracatçılar için bağlantıyı güçlendiren Hava Ulaştırma Anlaşması’nın yakın zamandaki genişlemesi de memnuniyetle karşılandı. 26 Haziran’da Ottawa’da Dışişleri Bakanı Anita Anand ile Türkiye Dışişleri Bakanı Hakan Fidan enerji, savunma, havacılık ve madencilikte ekonomik angajmanı artırma fırsatlarını ele aldı. Önümüzdeki aylarda teknik ekipler anlaşmanın kapsamı ve hedefini belirleyecek ve ilk müzakere turuna hazırlanacak. Kamu istişareleri 31 Temmuz–14 Eylül 2026 tarihleri arasında yapıldı. Kanada, 20 Ocak 2026’da Ottawa’da ikinci Kanada–Türkiye JETCO toplantısına ev sahipliği yaptı; ilk toplantı 2019’da İstanbul’da yapılmıştı. GAC ilişkiler sayfasına göre 2024’te iki yönlü mal ticareti 4,3 milyar doları aştı; Kanada ihracatı 1,3 milyar, Türkiye’den ithalat 3,1 milyar oldu. 2024’te Türkiye’den başlıca Kanada ithalatı yassı haddelenmiş demir sac ürünleri (203 milyon dolar), römorkörler (128 milyon) ve eczacılık ürünleri (107 milyon) idi. Çoğunluğu madencilikte olan Kanada’nın Türkiye’deki doğrudan yatırım stoku 2022’de 1 milyar dolardan 2023’te 420 milyon dolara geriledi. Sorular Ticaret Müzakereleri Birimi’ne (TCE), 111 Sussex Drive, Ottawa, ON K1N 1J1 veya TCE-Consultations@international.gc.ca adresine gönderilebilir.',
      category: 'Ekonomi',
      color: 'bg-primary',
      link: 'https://www.international.gc.ca/trade-commerce/trade-agreements-accords-commerciaux/agr-acc/turkiye/fta-ale/info.aspx?lang=eng',
    },
    {
      ...
      content:
        'IRCC’nin güncel Express Entry kategori bazlı turları ulaşım mesleklerini kapsıyor. Kategori bazlı davet için Express Entry asgari ölçütlerini, kapsadığı üç göçmenlik programından birine uygunluğu ve o turun talimatlarındaki tüm şartları karşılamanız gerekir. Bu kategoride, son üç yıl içinde IRCC listesindeki tek bir meslekte, Kanada’da veya yurt dışında, en az 12 aylık tam zamanlı (veya eşdeğer yarı zamanlı) iş deneyimi biriktirmiş olmalısınız; deneyimin kesintisiz olması veya asıl mesleğiniz olması gerekmez. 2026 ulaşım listesinde uçak mekanikçileri ve uçak müfettişleri (NOC 72404, TEER 2), hava pilotları, uçuş mühendisleri ve uçuş eğitmenleri (72600, TEER 2), uçak alet, elektrik ve aviyonik mekanikçileri, teknisyenleri ve müfettişleri (22313, TEER 2) ile otomotiv servis teknisyenleri, kamyon ve otobüs tamircileri ve mekanik tamirciler (72410, TEER 2) yer alıyor. 18 Şubat 2026’da Göçmenlik Bakanı Lena Metlege Diab kategoriyi duyururken pilotlar, uçak mekanikçileri ve müfettişlerini 2026 iş gücü açığı öncelikleri arasında vurguladı. Konuşma notlarında bu sektörlerin güçlendirilmesinin malların ülke içinde ve yeni pazarlara taşınmasına yardımcı olacağını, ticareti, tedarik zincirlerini ve ekonomik dayanıklılığı destekleyeceğini belirtti. IRCC’nin 2024–2025 Parlamento raporuna göre 2024 ulaşım kategorisi 2025’te Kanada Deneyim Sınıfı davetlerine yer açmak için sonlandırılmıştı; kategori 2026 listesinde yeniden yer alıyor. Ayrıntılar her turun talimatlarında yer alır; turlar gerçekleştikten sonra yayımlanır.',
      category: 'Göçmenlik',
      color: 'bg-primary',
      link: 'https://www.canada.ca/en/immigration-refugees-citizenship/services/immigrate-canada/express-entry/rounds-invitations/category-based-selection.html',
    },
