...
assert.match(enNews[0].content, /Current status: Closed|consultation page now lists|report summarizing the feedback|in negotiations|NATO Summit|4\.3 billion|TCE-Consultations/);
assert.match(trNews[0].content, /Current status: Closed|raporun yayımlanacağını|müzakerede|NATO Zirvesi|4,3 milyar|TCE-Consultations/);
